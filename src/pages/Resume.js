...
// import SophiaResume from "../images/resume.pdf";
...
const Resume = () => {
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} class="mt-5 ml-5">
        {/* {passwordIsCorrect ? (
          <div class="mt-4 font-gloria-hallelujah">success!</div>
        ) : null} */}
        ...
        {passwordIsCorrect ? (
          ...
          <div class="w-screen h-screen">
            ...
            <div class="grid place-items-center h-1/2 ">
              <div class="w-96 h-56 bg-blue-200 rounded-lg">
                <div class="mt-14">
                  <div class="flex justify-center">
                    <label
                      for="name"
                      class="w-full font-poppins grid place-items-center"
                    >
                  ...
                  <input
                    class="ml-12 font-gloria-hallelujah w-64 mr-5 ml-0.5 py-2 px-3 mt-2 text-xs rounded-lg shadow-sm text-gray-800 bg-neutral-100 leading-tight focus:outline-black ${(errors.name.length > 0) ? 'bg-neutral-800' : ''}`}"
                  ...
                  <div class="ml-12 text-xs text-red-500 ml-1 mt-1">
                    {!passwordIsCorrect && isSubmitted ? errors.password : ""}
                  </div>

                  <button
                    type="submit"
                    class="ml-12 w-44 font-gloria-hallelujah text-sm mt-2 py-1 px-5 bg-pink-300 text-white rounded hover:bg-pink-500"
                  >
                    ✨ Submit ✨
                  </button>
                </div>
